...
export const addVariant = async (variantData) => {
  try {
    const response = await axios.post(`${API_BASE_URL}/admin/variant/addVariant`, variantData);
...
export const getAllVariants = async () => {
  try {
    const response = await axios.get(`${API_BASE_URL}/admin/variant/getAllVariants`);
...
//   try {
//     const response = await axios.get(`${API_BASE_URL}/admin/getVariant/${variantId}`);
//     return response.data;
//   } catch (error) {

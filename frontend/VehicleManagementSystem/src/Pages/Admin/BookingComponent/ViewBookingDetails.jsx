...
const ViewBookingDetails = () => {
  ...
  if (!booking) {
    return <p className="text-center mt-5">No Booking details found for ID: {id}</p>;
  }
      ...
      <div className="row mb-4">
        <div className="col-md-4 mb-3">
          <div className="card h-100 shadow-sm">
            <img
              src={booking.carImage || "https://via.placeholder.com/300x200?text=Car+Image"}
        ...
        <div className="col-md-4 mb-3">
          <div className="card h-100 shadow-sm p-3">
            ...
            <p><strong>Model:</strong> {booking.variant}</p>
            <p><strong>Fuel Type:</strong> {booking.fuelType}</p>
            <p><strong>Rent/Day:</strong> ₹{booking.rentPerDay}</p>
      ...
      <div className="row mb-4">
        ...
        <div className="col-md-4 mb-3">
          <div className="card h-100 shadow-sm p-3">
            ...
            <p><strong>DL Number:</strong> {booking.dlNumber}</p>
            <div className="mt-2">
              <img
                src={booking.dlImage || "https://via.placeholder.com/250x150?text=DL+Image"}
                alt="Driving Licence"
        ...
        <div className="col-md-4 mb-3">
          <div className="card h-100 shadow-sm p-3 d-flex flex-column justify-content-between">
            <div>
              ...
              <p><strong>Transaction Time:</strong> {booking.transactionTime}</p>
            </div>
